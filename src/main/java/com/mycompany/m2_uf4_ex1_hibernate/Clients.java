...
public class Clients  implements java.io.Serializable {
    ...
    public String toString() {
        return "Clients{" + "codi=" + codi + ", nom=" + nom + ", adreca=" + adreca + ", codiPostal=" + codiPostal + ", poblacio=" + poblacio + ", limitCredit=" + limitCredit + ", dataUltimaCompra=" + dataUltimaCompra + '}';
    }
